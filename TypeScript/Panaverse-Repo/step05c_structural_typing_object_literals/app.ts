...
x = { id: 1, name: true, age: 21, salary: undefined };
console.log(x);
...
console.log(x = y);// Ok, `fullname` matched by index signature
...
var v: { foo: number, bar?: number };
v = { foo: 1, baz: 2 };  // Error, excess or misspelled property `baz`

var a: { foo: number };
var a1 = { foo: 1, baz: 2 };
console.log(a = a1);//No Error

var z: { foo: number, bar?: number };
var z1 = { foo: 1, baz: 2 };
console.log(z = z1);//No Error